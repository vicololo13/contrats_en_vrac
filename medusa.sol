...
contract Medusa is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Medusa", "MEDUSA", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xD0D6eE7fb4BAC1B65269F603aA4Db545bef41Aad; //eth
        TreasuryReceiver = 0x8E31f96C861469DC836CAEDd4E0D81EdC8DAA9e7; //AVAX
        RiskFreeValueReceiver = 0x5e005921AE3F21a07c97DA38D879cbFbfDbd37b3; //jeux poubelles
